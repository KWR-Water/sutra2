...
semiconfined_scheme = HydroChemicalSchematisation(schematisation_type='semiconfined',
                                    ...
                                    # biodegradation_sorbed_phase = False,
                                      ...
                                      diameter_gravelpack= 1.,  #made up value
                                      diameter_clayseal= 2., #made up value
                                      # substance = 'benzene',
                                      # halflife_oxic=600,
...
all_dicts  = { 'simulation_parameters' : semiconfined_scheme.simulation_parameters,
...
semi_dict_1 = copy.deepcopy(all_dicts)

semi_dict_1['geo_parameters'].pop('clayseal1')
# semi_dict_1['geo_parameters'].pop('gravelpack1')
semi_dict_1

semi_dict_2 = copy.deepcopy(all_dicts)
semi_dict_2['geo_parameters'].pop('layer1')
semi_dict_2['geo_parameters'].pop('layer2')
...
f = open("semiconfined_dict_nolayer1.txt","w")
...
phreatic_dict_1 = copy.deepcopy(all_dicts)

phreatic_dict_1['geo_parameters'].pop('clayseal1')
# phreatic_dict_1['geo_parameters'].pop('gravelpack1')
phreatic_dict_1

phreatic_dict_2 = copy.deepcopy(all_dicts)
phreatic_dict_2['geo_parameters'].pop('layer1')
phreatic_dict_2['geo_parameters'].pop('layer2')
...
f = open("phreatic_dict_nolayer1.txt","w")
